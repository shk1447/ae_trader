...
const getStockData = function () {
    let stockTrain = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../train.json')));
    let validStock = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../valid.json')));
    let testStock = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../test.json')));
...
const getEcgData = function () {
    let ecgTrain = JSON.parse(fs.readFileSync(path.resolve(__dirname, './data/ecg/train_scaled.json')));
    let testEcg = JSON.parse(fs.readFileSync(path.resolve(__dirname, './data/ecg/test_scaled.json')));
    let trainEcg = []
