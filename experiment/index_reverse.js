...
[trainStock, testStock] = dataUtils.getReverseStockData();
...
function computeAccuracyMetrics(data) {
  ...
  uniqueMse.forEach((each, i) => {
    ...
    rocSum +=
      ((prevMetric.tpr + metric.tpr) / 2) * (metric.fpr - prevMetric.fpr);
